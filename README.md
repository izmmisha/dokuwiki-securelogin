...
--------------
  ...
  - Download and install the plugin using the Plugin Manager, please use the download link given above. Refer to [[:Plugins]] on how to install plugins manually.
